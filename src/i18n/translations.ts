...
const es = {
  ...
  projects: {
    ...
    stars: 'Estrellas',
    languages: 'Lenguajes',
    readAt: 'Leído de la API de GitHub',
  },
  contact: {
    title: '¿Hablamos?',
...
const en: Translation = {
  ...
  projects: {
    ...
    stars: 'Stars',
    languages: 'Languages',
    readAt: 'Read from the GitHub API',
  },
  contact: {
    title: 'Let’s talk.',
...
const de: Translation = {
  ...
  projects: {
    ...
    viewRepo: 'Repository auf GitHub ansehen',
    scope: 'Woraus sie besteht',
    status: 'Stand des Repositorys',
    ...
    stars: 'Sterne',
    languages: 'Sprachen',
    readAt: 'Aus der GitHub-API gelesen',
  },
  contact: {
    title: 'Reden wir?',
